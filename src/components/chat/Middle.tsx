      ...
      <div className="flex-1 p-4 overflow-y-auto">
        <div className="flex items-center justify-between p-1 bg-white shadow-sm">
          ...
          <div className="flex items-center gap-3">
            <img src="/man.jpeg" alt="User" className="w-7 h-7 rounded-full" />
            <div className="flex flex-col">
              <span className="text-sm font-medium">Yoge vege kara</span>
              <span className="text-xs text-gray-500">
                oguz@bluereceipt.com
              </span>
            </div>
          </div>
          ...
          <div className="w-full max-w-2xl mx-auto p-4 space-y-4 bg-gray-50">
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="bg-white rounded-lg p-3 shadow-sm max-w-md">
                <p className="text-sm text-gray-700">
                  I keep getting "error while creating a new pop up" for the
                  first time setup, so I'm not able to create a pop up. My shop
                  name is PinkSweetHeart
                </p>
              </div>
            </div>
            ...
            <div className="flex justify-end relative">
              <div className="bg-blue-600 text-white p-3 rounded-lg max-w-md pr-8">
                <p className="text-sm">
                  Hey, #firstname! I saw you were curious about our products. My
                  name is X from StoreName, feel free to save my number and send
                  me a text if you have any questions or concerns. If you're
                  ready to
                </p>
