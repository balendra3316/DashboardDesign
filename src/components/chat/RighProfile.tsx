...
const RighProfile = () => {
  return (
    ...
    <div className="flex flex-col items-center w-40 h-27 border rounded-md p-4">
      ...
      <span className="text-2xl font-semibold text-center">$3,452</span>
      <span className="text-sm text-gray-500 text-center">3 Orders</span>
    </div>
    ...
    <div className="flex flex-col items-center w-40 h-27 border rounded-md p-4">
      ...
      <span className="text-sm text-gray-500 text-center">4 Link Clicks</span>
    </div>
  </div>
...
<div className="border-t pt-4">
  ...
  <div className="space-y-2 text-sm">
    ...
    <div className="grid grid-cols-2 gap-x-4 items-center">
      ...
      <span className="justify-self-end">oguzyagizkara@gmail.com</span>
    </div>
    <div className="grid grid-cols-2 gap-x-4 items-center">
      <div className="flex items-center gap-2 text-gray-600">
        <MdLocalPhone />
